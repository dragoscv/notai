...
export function ContactForm() {
  ...
  if (state.status === 'success') {
    return (
      ...
      >
        <p className="text-foreground font-medium">Thanks — your message is on its way.</p>
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-2">
        ...
        />
        {fieldErrors.name ? (
          <p id="contact-name-err" className="text-destructive text-xs">
            {fieldErrors.name}
          </p>
        ) : null}
      </div>
      ...
      <div className="grid gap-2">
        ...
        />
        {fieldErrors.email ? (
          <p id="contact-email-err" className="text-destructive text-xs">
            {fieldErrors.email}
          </p>
        ) : null}
      </div>
      ...
      <div className="grid gap-2">
        ...
        />
        {fieldErrors.subject ? (
          <p id="contact-subject-err" className="text-destructive text-xs">
            {fieldErrors.subject}
          </p>
        ) : null}
      </div>
      ...
      <div className="grid gap-2">
        ...
        />
        {fieldErrors.message ? (
          <p id="contact-message-err" className="text-destructive text-xs">
            {fieldErrors.message}
          </p>
        ) : null}
      </div>
