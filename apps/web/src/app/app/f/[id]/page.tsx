        ...
        <div className="flex h-full flex-col">
            <header className="flex items-center justify-between gap-2 border-b px-4 py-3 md:px-6 md:py-4">
                <div className="flex min-w-0 items-center gap-2">
                    <SidebarToggle />
                    <NoteIcon icon={folder.icon} className="size-5 shrink-0" fallback={<FolderGlyph className="size-5 shrink-0 text-muted-foreground" />} />
            ...
            <div className="flex-1 overflow-y-auto p-6">
                {notesInFolder.length === 0 ? (
                    ...
                    <>
                        ...
                        <section>
                            <h2 className="mb-3 text-sm font-medium text-muted-foreground">All notes</h2>
