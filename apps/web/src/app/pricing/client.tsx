...
export function PricingClient({ plans, signedIn }: { plans: PublicPlan[]; signedIn: boolean }) {
  ...
  return (
    <div className="bg-background text-foreground relative min-h-dvh overflow-hidden">
      <div className="from-primary/[0.08] pointer-events-none fixed inset-0 -z-10 bg-gradient-to-br via-transparent to-transparent" />
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <Link href={signedIn ? '/app' : '/signin'} className="text-sm font-medium hover:underline">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-12">
        ...
        <p className="text-muted-foreground mx-auto mt-12 max-w-xl text-center text-xs">
          Prices include VAT where applicable. Cancel anytime from the app. Payments handled by
