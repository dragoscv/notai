...
function CookieBanner({ onCustomize }: { onCustomize: () => void }) {
    ...
    return (
        ...
        >
            <div className="mx-auto flex max-w-3xl flex-col gap-4 rounded-2xl border border-border/70 bg-background/95 p-4 shadow-2xl backdrop-blur-md sm:p-5">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1 text-sm leading-relaxed text-foreground">
                        ...
                        <p className="text-muted-foreground">
                            Notai uses cookies that are strictly necessary to sign you in
                            and keep the app working. Optional cookies for preferences and
                            anonymous analytics help us improve. You can change your mind
                            anytime from the{' '}
...
function CookieSettingsDialog() {
    ...
    return (
        ...
        >
            <div className="relative flex max-h-[90dvh] w-full max-w-lg flex-col gap-4 overflow-hidden rounded-2xl border border-border/70 bg-background p-5 shadow-2xl">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        >
                            Choose which optional cookies Notai may use. Your choice is
                            saved on this device for 12 months.
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <div className="-mx-1 flex flex-col gap-3 overflow-y-auto px-1">
                    {CATEGORIES.map((cat) => (
                        <div
                            key={cat.key}
                            className={cn(
                                'flex items-start justify-between gap-4 rounded-xl border border-border/60 bg-card/50 p-3',
                            )}
                        >
